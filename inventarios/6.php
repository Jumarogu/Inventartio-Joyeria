...
<html>
	...
	<body>
		...
		<h3 align="center">Inventario Arracada Plata</h3>
		<!-- UI - X Starts -->
		<div class="ui-273">
			<!-- Table Responsive -->
			<div class="table-responsive">
				...
				<table class="table table-bordered">
					...
					<?php
						    ...
						    if ($conn) {
								$query = "SELECT nombre, metal, kilataje, joya, pesoBruto FROM (SELECT * FROM Categoriaj WHERE IDcategoria = '6') b LEFT JOIN (SELECT Joya, Cantidad, IDcategoria from Piezaj) a ON a.IDcategoria=b.IDcategoria";
